...
export const projects = [
  {
    title: "Hoobank",
    description:
      "Using Vite.js (React) shows a bank web with multiple components who shows different ways to reuse the components",
    image: "./images/1.png",
  ...
  },
  {
    ...
    description:
      "RPG game build with JavaScript who allows to the player kill a dragon. For that purpose you need to buy new weapons or health",
    image: "./images/4.png",
  ...
  },
  {
    title: "Movie Review",
    description:
      "Webpage with a Movie Database API, taken from 'The Movie Database', who admit reviews. This reviews it can be erased or modify",
    image: "./images/5.png",
  ...
  },
  {
    title: "Gym Form (ES)",
    description:
      "Webpage with a form. It emulates a gym database with a 'Member List', 'New Signups' and a section to Modify / Erase Members (on Spanish)",
    image: "./images/6.png",
    tags: ["HTML", "CSS", "JavaScript"],
  ...
  },
  {
    ...
    tags: ["React", "HTML", "CSS", "JavaScript"],
    source: "https://github.com/marasortiz/calculator",
    visit: "https://marasortiz.github.io/calculator/",
    id: 7,
  },
];
...
export const proyectos = [
  ...
  },
  {
    title: "Calculadora",
    description:
      "Una calculadora 'simple' en React que maneja cambios de entrada, interacción del usuario y cálculos complejos.",
    image: "./images/calc.png",
    tags: ["React", "HTML", "CSS", "JavaScript"],
    source: "https://github.com/marasortiz/calculator",
    visit: "https://marasortiz.github.io/calculator/",
